...
## Latest Admin/Technician Updates

This version includes:

- Admin sidebar User Management page
- Admin can create/edit/delete users and change password/role/department/status
- Admin sidebar Department Management page
- Admin can create and rename departments
- Admin can assign technician, update ticket status, and add remark
- Technician assigned tickets page includes status update and remark box
- Technician must enter a remark when marking a ticket as Solved
